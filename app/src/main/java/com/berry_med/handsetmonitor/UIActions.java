...
//					    break;
    ...
    private static void RecordShow() {
        ...
        //if (!isMainScreenShow) {
            ...
            Intent intent = new Intent(MainActivity.mContext, ScoreActivity.class);
    ...
    private static void BluetoothSelectShow(final BluetoothUtils mBluetoothUtils) {
        ...
        if (!isMainScreenShow) {
            ...
            MainActivity.llBT.setLayoutParams(new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 2.5f));
            MainActivity.llCFG.setLayoutParams(new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1.0f));
    ...
    public static void ShowMainScreen() {
        ...
        MainActivity.llBT.setLayoutParams(new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1.0f));
        MainActivity.llCFG.setLayoutParams(new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1.0f));
    ...
    private static void RLConfigShow() {
        ...
        if (isMainScreenShow) {
            ...
            MainActivity.llConsciousness.setVisibility(View.GONE);
            MainActivity.llScore.setVisibility(View.GONE);
            MainActivity.llEcg.setVisibility(View.GONE);
...
//	}
    ...
    public static void RefreshSpO2(int arg1) {
        ...
        if (arg1 != CONST.SPO2_INVALID_VALUE) {
            ...
            MainActivity.tvSpO21.setText(arg1 + "");
        } else {
            MainActivity.tvSpO2.setText(R.string.tvSpO2Invalid);
            MainActivity.tvSpO21.setText(R.string.tvSpO2Invalid);
        }
    }
    ...
    public static void RefreshPR(int arg2) {
        ...
        if (arg2 != CONST.PR_INVALID_VALUE) {
            ...
            MainActivity.tvPR1.setText(arg2 + "");
        } else {
            MainActivity.tvPR.setText(R.string.tvPRInvalid);
            MainActivity.tvPR1.setText(R.string.tvPRInvalid);
        }
    }
    ...
    public static void RefreshResp(int arg1) {
        ...
        if (arg1 != CONST.RESP_INVALID_VALUE) {
            ...
            MainActivity.tvResp1.setText(arg1 + "");
        } else {
            MainActivity.tvResp.setText(R.string.tvRespInvalid);
            MainActivity.tvResp1.setText(R.string.tvRespInvalid);
        }
    ...
    public static void RefreshHR(int arg2) {
        ...
        if (arg2 != CONST.HR_INVALID_VALUE) {
            ...
            MainActivity.tvHR1.setText(arg2 + "");
        } else {
            MainActivity.tvHR.setText(R.string.tvHRInvalid);
            MainActivity.tvHR1.setText(R.string.tvHRInvalid);
        }
